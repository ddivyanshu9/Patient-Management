...
public class PatientRequestDTO {
    ...
    public @NotBlank(message = "Email is required") @Email(message = "Email should not be blank") String getEmail() {
        return email;
    }

    public void setEmail(@NotBlank(message = "Email is required") @Email(message = "Email should not be blank") String email) {
        this.email = email;
    }
